...
import emrServerlessRoutes from "./emrserverless";
import mwaaRoutes from "./mwaa";
import rumRoutes from "./rum";
import bedrockAgentCoreRoutes from "./bedrockagentcore";
import fisRoutes from "./fis";
import guardDutyRoutes from "./guardduty";
import cloudHsmRoutes from "./cloudhsm";
import s3TablesRoutes from "./s3tables";
import cloudControlRoutes from "./cloudcontrol";
...
import dynamodbStreamsRoutes from "./dynamodb-streams";
import rdsRoutes from "./rds";
import ec2Routes from "./ec2";
import ec2FlowLogsRoutes from "./ec2-flow-logs";
import ec2NetworkAclsRoutes from "./ec2-network-acls";
...
import sesV2Routes from "./ses-v2";
...
import s3SelectRoutes from "./s3-select";
...
import applicationAutoScalingRoutes from "./applicationautoscaling";
...
router.route("/emrserverless", emrServerlessRoutes);
router.route("/mwaa", mwaaRoutes);
router.route("/rum", rumRoutes);
router.route("/bedrockagentcore", bedrockAgentCoreRoutes);
router.route("/fis", fisRoutes);
router.route("/guardduty", guardDutyRoutes);
router.route("/cloudhsm", cloudHsmRoutes);
router.route("/s3tables", s3TablesRoutes);
router.route("/cloudcontrol", cloudControlRoutes);
...
router.route("/ec2", ec2FlowLogsRoutes);
router.route("/ec2", ec2NetworkAclsRoutes);
...
router.route("/email/v2", sesV2Routes);
...
router.route("/applicationautoscaling", applicationAutoScalingRoutes);
