...
| **Auto Scaling** | Auto Scaling Groups (list, create, update, delete, set desired capacity), launch configurations (list), scaling policies (list per ASG), scaling activities (list per ASG), instance refresh (start/list), ASG tags (create/delete), LB target groups (attach/detach/list), classic load balancers (attach/detach/list) |
